...
$res1->mock('text',sub{'f_P7lQkhkg4JD5Xq0LCl:60:60:websocket,htmlfile,xhr-polling,jsonp-polling'});
...
ok($obj->is_timeout, 'set timeout');
is($url,'wss://plug.coinsetter.com:3000/socket.io/1/websocket/f_P7lQkhkg4JD5Xq0LCl');
...
lives_ok(sub{
					 ...
					 $socket->emit('text','5:::{"name":"last","args":[{"price":367,"size":0.03,"exchangeId":"COINSETTER","timeStamp":1417382915802,"tickId":14667678802537,"volume":14.86,"volume24":102.43}]}');
				 },'parse connect');
