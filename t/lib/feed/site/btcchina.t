...
my $socket = Mojo::Transaction::WebSocket::ForBtcChina->new();
...
lives_ok(sub{
					 ...
					 $socket->emit('text','42["trade",{"trade_id":13717874,"type":"sell","price":"2327.05","amount":"1.45510000","date":1417673447,"market":"btccny"}]');
				 },'receive data');
